...
func addUpdateEndpointMiddleware(stack *middleware.Stack, options Options) {
	s3cust.UpdateEndpoint(stack, s3cust.UpdateEndpointOptions{Region: options.Region, GetBucketFromInput: getBucketFromInput, UsePathStyle: options.UsePathStyle, UseAccelerate: options.UseAccelerate})
}
